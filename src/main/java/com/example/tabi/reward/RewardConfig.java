package com.example.tabi.reward;

public class RewardConfig {
    // 각 변수의 의미 -> 경험치, 뽑기권 종류, 뽑기권 개수, 코인
    public static final int QUEST_EXPERIENCE = 1;
    public static final boolean QUEST_TYPE = true;
    public static final int QUEST_CREDIT_CARD_COUNT = 1;
